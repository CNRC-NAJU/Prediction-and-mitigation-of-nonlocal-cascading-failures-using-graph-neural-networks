...
class MotterLaiData:
    ...
    def from_hp(
        ...
        stage: str | Stage,
        hp: HyperParameter,
        network_list: str | list[str] | None = None,
        index_list: list[Any] | None = None,
        scaler: sc.BaseScaler | None = None,
    ):
    ...
    def get_loader(
        self, batch_size: int | None = None, pin_memory: bool = True
    ) -> gLoader.DataLoader:
        if batch_size is None:
            batch_size = self.batch_size
        return gLoader.DataLoader(
            self.data_list,  # type:ignore
    ...
    def read_df_with_index(
        self, file: Path, index: None | float | tuple[float, float] | pd.Index
